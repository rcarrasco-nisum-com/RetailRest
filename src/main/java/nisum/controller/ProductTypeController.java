...
public class ProductTypeController {
    ...
    public @ResponseBody
    ProductTypeResources getProductTypeList() throws Exception {
    ...
    @RequestMapping(value = "/{id}",
            method = RequestMethod.GET, produces = "application/json")
    public @ResponseBody
    ProductTypeResource getProductTypeById(@PathVariable("id") int id) throws Exception {

        Assert.isTrue(Integer.class.isInstance(id), "The id must to be integer");
    ...
    //    if(validateProductType(productTypeIn)){
   ...
   //     }
    ...
    private void addProductTypeLinks(List<ProductTypeResource> productTypeResourceList) throws Exception {
    ...
    private void addProductTypeLinks(ProductTypeResource productTypeResource) throws Exception {
        addSelfLink(productTypeResource);
    }

    private void addSelfLink(ProductTypeResource productTypeResource) throws Exception {
    ...
    /*
    private boolean validateProductType(ProductTypeIn productTypeIn){
       if(productTypeIn != null) {
           return true;
       }else {
           throw new IdNotFoundException("Product Type does not exist");
       }
    }*/
}
