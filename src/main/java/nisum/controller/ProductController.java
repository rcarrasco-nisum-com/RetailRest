...
public class ProductController {
    ...
    @RequestMapping(value = "/{id}",
            method = RequestMethod.GET, produces = "application/json")
    public @ResponseBody
    ProductResource getProductById(@PathVariable("id") int id) throws Exception {
    ...
    private void addProductLinks(List<ProductResource> productResourceList) throws Exception {
    ...
    private void addProductLinks(ProductResource productResource) throws Exception {
        addSelfLink(productResource);
        addProductTypeLink(productResource);
    }

    private void addSelfLink(ProductResource productResource) throws Exception {
        productResource.add(linkTo(methodOn(ProductController.class)
                .getProductById(productResource.getProductid())).withSelfRel());
    }

    private void addProductTypeLink(ProductResource productResource) throws Exception {
